...
// TODO: Using this until socket.io v3 is part of NestJS, see: https://github.com/nestjs/nest/issues/5676
  ...
  public createIOServer(port: number, options?: any): any {
    if (this.httpServer && port === 0) {
      const s = new Server(this.httpServer, {
        cors: {
          origin: this.corsOrigin, // Replicates the same origin set in main.ts
          methods: ['GET', 'POST'],
          credentials: true,
        },
        cookie: {
