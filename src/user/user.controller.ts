...
import { ResponseAdminDto } from '../users/admins/dtos/response-admin.dto';
import { Admin } from '../users/admins/entities/admin.entity';
import { ResponseCampusUserDto } from '../users/campus-users/dtos/response-campus-user.dto';
import { CampusUser } from '../users/campus-users/entities/campus-user.entity';
import { ResponseProfessorshipDto } from '../users/professorships/dtos/response-professorship.dto';
import { Professorship } from '../users/professorships/entities/professorship.entity';
import { ResponseScholarshipDto } from '../users/scholarships/dtos/response-scholarship.dto';
